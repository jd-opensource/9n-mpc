...
export MODE=local
export RAW_DATA_DIR=${BASE_DIR}/example/mnist_data/leader_train
#数据求交的原始目录，替换成你自己的目录
export DATA_BLOCK_DIR=${BASE_DIR}/example/mnist_data/data_block_leader
#数据求交结果存放的额目录，替换成你自己的目录

export PORT0="6001"
export REMOTE_IP="0.0.0.0:5001"
# leader: 0.0.0.0:6001
